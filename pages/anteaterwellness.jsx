    ...
    <div>
      ...
      <div className="project-container">
        ...
        <div className="project-section">
          ...
          <div className="project-subsection">
            ...
            <p className="project-p">
              ...
              elicitation sessions with the center&apos;s staff to gather
              information on the goals and requirements of the Anteater Wellness
              Application.
            </p>
            <p className="project-p">
            ...
            <p className="project-p">
              ...
              Wellness Application was envisioned to foster continuous progress
              in the mental health and overall wellbeing of UCI students.
            </p>
          </div>
          <div className="project-subsection">
            ...
            <p className="project-p">
              ...
              <span className="highlight4">
                The application&apos;s functionality is designed specifically to
                improve the health and well-being of these students.
              </span>{" "}
              It provides a valuable resource for individuals who seek to
              enhance their physical, emotional, intellectual, financial,
              social, and spiritual health. The Anteater Wellness application
              offers personalized wellness assessments, goal-setting tools, and
              access to wellness-related events, making it a comprehensive
              resource for students committed to improving their overall health
              and well-being.
            </p>
            ...
            <p className="project-p">
              <span className="highlight4">
                ...
                UCI-affiliated wellness events on the app and encouraging
                student participation.
              </span>{" "}
              They may also interact with student users by commenting on posts
              and providing feedback on their wellness progress. In addition,
              staff members may use the app to connect with students who may
              require further assistance or support in enhancing their wellness.
              The system generates reports on user engagement, goal completion
              rates, and other relevant metrics to assist staff members in
              improving the effectiveness of the app in promoting student
              wellness.
            </p>
            <label className="project-label-18">
          ...
          <div className="project-subsection">
            ...
            <p className="project-p">
              ...
              Irvine.{" "}
              <span className="highlight4">
                The main goal of these survey was to understand the health &
          ...
          <div className="project-subsection">
            ...
            <p className="project-p">
              Based on my surveys and elicitation sessions,{" "}
              <span className="highlight4">
                I visualized the relationship between students&apos; experiences
                with health and wellness and the goals of the Wellness Center.
              </span>{" "}
              To ensure inclusivity for all students, I created a persona for
              each of the main student types I encountered.
            </p>
            <Image className="img" src={persona1} alt={"Survey Results"} />
            <Image className="img" src={persona2} alt={"Survey Results"} />
            <Image className="img" src={persona3} alt={"Survey Results"} />
          </div>
        </div>
        ...
        <div className="project-section">
          ...
          <div className="project-subsection">
            ...
            <p className="project-p">
              ...
              applications and their feature sets.{" "}
              <span className="highlight4">
                Since this particular application focuses on improving
                students&apos; mental health through event scheduling and health
                tracking, I specifically looked at the main features of mental
                health, events, and goal tracking apps.
              </span>
            </p>
            <Image
              className="img"
          ...
          <div className="project-subsection">
            ...
            <p className="project-p">
              ...
              identified{" "}
              <span className="highlight4">
                preliminary goals of the application: foster relationships
                between students, encourage students to achieve personal
                wellness goals, connect the Wellness Center staff with students,
                and increase Wellness Center event participation
              </span>
            </p>
            <p className="project-p">
        ...
        <div className="project-section">
          ...
          <Image className="img" src={userflowimg} alt={"User Flow"} />
          <p className="project-p">
        ...
        <div className="project-section">
          ...
          <div className="project-subsection">
            ...
            <p className="project-p">
              ...
              vibrancy and warmth. Blue is easy on the eyes and won&apos;t cause
              any unnecessary strain, making it an ideal choice for long periods
              of use. By using blue and yellow as accent colors, the application
            ...
            <p className="project-p">
              ...
              displaying different types of information. The font&apos;s fresh
              and contemporary feel aligns with the application&apos;s overall
              objective of promoting health and wellness among college students.
            ...
            <div className="display-container">
              ...
              <div className="display-description">
                ...
                <p className="project-p">
                  ...
                  students&apos; holistic wellness journeys by connecting them
                  with like-minded peers and relevant resources.
                </p>
              </div>
            </div>
            <div className="display-container">
