    ...
    <div>
      ...
      <div className="project-container">
        ...
        <div className="project-section">
          ...
          <label className="project-label-large">Design Question</label>
          <div className="card-large">
            <label htmlFor="">Design Question</label>
        ...
        <div className="project-section">
          ...
          <p className="project-p">
            ...
            relationship between students' experiences with health and wellness
            and the goals of the Wellness Center. To ensure inclusivity for all
            students, I created a persona for each of the main student types I
            encounter
          </p>
          <Image
            className="project-img-full"
        ...
        <div className="project-section">
          ...
          <div className="project-subsection">
            ...
            <p className="project-p">
              ...
              user community. By embracing the user-centered design process and
              staying attuned to the needs of the users, I was able to create a
              product that is both functional and effective. Overall, I am
              grateful for the opportunity to have designed a product that will
              have a positive impact on the health and wellness of its users.
            </p>
          </div>
          <div className="project-subsection">
            <h3 className="project-h3">Maintaining The Scope</h3>
            <p className="project-p">
              During this project, I encountered a persistent challenge in
              balancing the features and timeline of the project. Through
              elicitation sessions held over the first four weeks, it became
              clear that catering to every stakeholder request was not feasible.
              My field notes quickly became a long list of feature descriptions,
              which seemed overwhelming at first. However, after conducting a
              survey with UCI students, I was able to identify the most feasible
              features that could be completed within the given timeline.
            </p>
            <p className="project-p">
              ...
              deliverables. By focusing on the most impactful features and
              ensuring they were executed well, I was able to achieve a balance
              between the project timeline and the final deliverables. Overall,
              this experience has enhanced my ability to manage stakeholder
              expectations, prioritize deliverables and make decisions that
