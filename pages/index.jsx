...
import medspa from "@/public/assets/img/medspa.jpg";
...
export default function Home(objectData) {
  ...
  useEffect(() => {
    let tl = gsap.timeline({
      defaults: { ease: "power2", duration: 2, delay: 0.1 },
    });
    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.projects}>
            <a
              className={styles.freelance_card}
              href="https://www.socalbeautymedspa.com/"
            >
              <Image
                ...
                quality={100}
              />
              <label className={styles.freelance_label}>
