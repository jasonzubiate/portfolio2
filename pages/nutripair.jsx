        ...
        <div className="project-section">
          ...
          <div className="project-subsection">
            ...
            <p className="project-p">
              ...
              based on feedback, I had to ensure that our team was keeping users
              engaged throughout the testing phase.
            </p>
            <label className="project-label-18">
            ...
            <p className="project-p">
              ...
              position as a frontend intern at Nutripair,{" "}
              <span className="highlight">
                my team valued the feasibility of my design decisions in
                relation to the capabilities of the remaining tech development
                team.
              </span>{" "}
              Throughout the testing cohort, I worked closely with the frontend
              team to clarify high-priority items that could realistically be
              delivered in our fast-paced testing timeline and backlog items
              that would require more time allocation to implement. This
              ultimately ensured that our team rolled out features with the
              highest value to the users, without overwhelming the rest of the
              team.
            </p>
          </div>
        </div>
